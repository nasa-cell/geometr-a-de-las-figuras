window.gameData = [
  ...
  },
  {
    ...
    pool: [
      { q: "¿Cuántos lados tiene un trapecio rectángulo?", a: ["2", "3", "4", "5"], c: 2, topic: "lados" },
      { q: "¿Cuántos vértices tiene un trapecio rectángulo?", a: ["3", "4", "5", "6"], c: 1, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un trapecio rectángulo?", a: ["3", "4", "5", "6"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un trapecio rectángulo?", a: ["1", "2", "3", "4"], c: 1, topic: "diagonales" },
      { q: "¿Cuánto suman los ángulos internos de un trapecio rectángulo?", a: ["180°", "270°", "360°", "450°"], c: 2, topic: "angulos" }
    ]
  },
  {
    ...
    pool: [
      { q: "¿Cuántos lados tiene un trapecio escaleno?", a: ["2", "3", "4", "5"], c: 2, topic: "lados" },
      { q: "¿Cuántos vértices tiene un trapecio escaleno?", a: ["3", "4", "5", "6"], c: 1, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un trapecio escaleno?", a: ["3", "4", "5", "6"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un trapecio escaleno?", a: ["1", "2", "3", "4"], c: 1, topic: "diagonales" },
      { q: "¿Cuánto suman los ángulos internos de un trapecio escaleno?", a: ["180°", "270°", "360°", "450°"], c: 2, topic: "angulos" }
    ]
  },
  {
    name: "Trapezoide",
    shape: "trapezoide",
    pool: [
      { q: "¿Cuántos lados tiene un trapezoide?", a: ["2", "3", "4", "5"], c: 2, topic: "lados" },
      ...
      { q: "¿Cuántas diagonales tiene un trapezoide?", a: ["1", "2", "3", "4"], c: 1, topic: "diagonales" },
      { q: "¿Cuánto suman los ángulos internos de un trapezoide?", a: ["180°", "270°", "360°", "450°"], c: 2, topic: "angulos" }
    ]
  },
  {
    name: "Pentágono",
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un heptágono?", a: ["6", "7", "8", "9"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un heptágono?", a: ["10", "12", "14", "16"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un octágono?", a: ["6", "7", "8", "9"], c: 2, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un octágono?", a: ["16", "18", "20", "22"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un nonágono?", a: ["7", "8", "9", "10"], c: 2, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un nonágono?", a: ["24", "25", "27", "30"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un decágono?", a: ["8", "9", "10", "11"], c: 2, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un decágono?", a: ["30", "32", "35", "40"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un endecágono?", a: ["9", "10", "11", "12"], c: 2, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un endecágono?", a: ["36", "40", "44", "48"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un dodecágono?", a: ["10", "11", "12", "13"], c: 2, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un dodecágono?", a: ["48", "50", "54", "56"], c: 2, topic: "diagonales" },
  ...
  },
  {
    ...
    shape: "circle",
    pool: [
      { q: "¿Cuántos lados tiene un círculo?", a: ["0", "1", "2", "Infinitos"], c: 0, topic: "lados" },
      { q: "¿Cuántos vértices tiene un círculo?", a: ["0", "1", "2", "Infinitos"], c: 0, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un círculo?", a: ["0", "1", "2", "Infinitos"], c: 0, topic: "angulos" }
    ]
  },
  {
    name: "Óvalo",
    shape: "oval",
    pool: [
      { q: "¿Cuántos lados tiene un óvalo?", a: ["0", "1", "2", "4"], c: 0, topic: "lados" },
      { q: "¿Cuántos vértices tiene un óvalo?", a: ["0", "1", "2", "4"], c: 0, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un óvalo?", a: ["0", "1", "2", "Infinitos"], c: 0, topic: "angulos" }
    ]
  },
  {
    name: "Media Luna",
    shape: "crescent",
    pool: [
      { q: "¿Cuántos lados tiene una media luna?", a: ["0", "1", "2", "3"], c: 0, topic: "lados" },
      { q: "¿Cuántos vértices tiene una media luna?", a: ["0", "1", "2", "3"], c: 0, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene una media luna?", a: ["0", "1", "2", "3"], c: 0, topic: "angulos" }
    ]
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántas diagonales tiene una estrella de 5 puntas?", a: ["10", "15", "20", "35"], c: 3, topic: "diagonales" }
    ]
  },
  {
    name: "Corazón",
    shape: "heart",
    pool: [
      { q: "¿Cuántos lados tiene un corazón estilizado?", a: ["0", "1", "2", "3"], c: 1, topic: "lados" },
      { q: "¿Cuántos vértices tiene un corazón estilizado?", a: ["0", "1", "2", "3"], c: 1, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un corazón estilizado?", a: ["0", "1", "2", "3"], c: 0, topic: "angulos" }
    ]
  },
  {
    name: "Semicírculo",
    shape: "semicircle",
    pool: [
      { q: "¿Cuántos lados tiene un semicírculo?", a: ["0", "1", "2", "3"], c: 1, topic: "lados" },
      { q: "¿Cuántos vértices tiene un semicírculo?", a: ["0", "1", "2", "3"], c: 2, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un semicírculo?", a: ["0", "1", "2", "3"], c: 0, topic: "angulos" }
    ]
  },
  {
    ...
    pool: [
      ...
      { q: "¿Cuántos ángulos tiene un triángulo rectángulo?", a: ["2", "3", "4", "5"], c: 1, topic: "angulos" },
      { q: "¿Cuánto mide el ángulo recto de un triángulo rectángulo?", a: ["60°", "90°", "120°", "45°"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un triángulo rectángulo?", a: ["0", "1", "2", "3"], c: 0, topic: "diagonales" }
    ]
  },
  {
    ...
    pool: [
      { q: "¿Cuántos lados tiene un triángulo isósceles?", a: ["2", "3", "4", "5"], c: 1, topic: "lados" },
      { q: "¿Cuántos vértices tiene un triángulo isósceles?", a: ["2", "3", "4", "5"], c: 1, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un triángulo isósceles?", a: ["2", "3", "4", "5"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un triángulo isósceles?", a: ["0", "1", "2", "3"], c: 0, topic: "diagonales" },
      { q: "¿Cuánto suman los ángulos internos de un triángulo isósceles?", a: ["90°", "180°", "360°", "120°"], c: 1, topic: "angulos" }
    ]
  },
  {
    ...
    pool: [
      { q: "¿Cuántos lados tiene un trapecio isósceles?", a: ["2", "3", "4", "5"], c: 2, topic: "lados" },
      { q: "¿Cuántos vértices tiene un trapecio isósceles?", a: ["3", "4", "5", "6"], c: 1, topic: "vertices" },
      { q: "¿Cuántos ángulos tiene un trapecio isósceles?", a: ["3", "4", "5", "6"], c: 1, topic: "angulos" },
      { q: "¿Cuántas diagonales tiene un trapecio isósceles?", a: ["1", "2", "3", "4"], c: 1, topic: "diagonales" },
      { q: "¿Cuánto suman los ángulos internos de un trapecio isósceles?", a: ["180°", "270°", "360°", "450°"], c: 2, topic: "angulos" }
    ]
  }
];
